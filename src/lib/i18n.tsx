...
const en: Dict = {
  ...
  "stats.kpi.total_matches": "Total matches",
  "stats.kpi.total_goals": "Total goals",
  "stats.kpi.avg_goals": "Avg goals / match",
  "stats.kpi.most_active": "Most active",
  "stats.kpi.top_scorer": "Top scorer",
  "stats.kpi.best_defense": "Best defense",
  "stats.kpi.best_win_rate": "Best win rate",
  "stats.kpi.most_used_team": "Most used team",
  "stats.filter.all": "All time",
  "stats.filter.week": "This week",
  "stats.filter.month": "This month",
  "stats.filter.custom": "Custom",
  "stats.filter.from": "From",
  "stats.filter.to": "To",
  "stats.matches_played": "Matches played",
  "stats.goals_scored": "Goals scored",
  "stats.goals_conceded": "Goals conceded",
  "stats.goals_over_time": "Goals over time",
  "stats.details": "Details",
  "stats.player_details": "Player details",
  "stats.team_details": "Team details",
  ...
  "ranking.champion": "Current champion",
  "ranking.best_winrate": "Best win rate",
  "ranking.top_scorer": "Top scorer",
  "ranking.most_active": "Most active",
  "ranking.played": "Played",
  "ranking.wins": "Wins",
  "ranking.draws": "Draws",
  "ranking.losses": "Losses",
  "ranking.goals_for": "GF",
  "ranking.goals_against": "GA",
  "ranking.goal_diff": "GD",
  "ranking.win_rate": "Win %",
...
const pt: Dict = {
  ...
  "stats.kpi.total_matches": "Partidas totais",
  "stats.kpi.total_goals": "Gols totais",
  "stats.kpi.avg_goals": "Média gols / jogo",
  "stats.kpi.most_active": "Mais ativo",
  "stats.kpi.top_scorer": "Artilheiro",
  "stats.kpi.best_defense": "Melhor defesa",
  "stats.kpi.best_win_rate": "Maior aproveitamento",
  "stats.kpi.most_used_team": "Time mais usado",
  "stats.filter.all": "Sempre",
  "stats.filter.week": "Esta semana",
  "stats.filter.month": "Este mês",
  "stats.filter.custom": "Personalizado",
  "stats.filter.from": "De",
  "stats.filter.to": "Até",
  "stats.matches_played": "Partidas jogadas",
  "stats.goals_scored": "Gols marcados",
  "stats.goals_conceded": "Gols sofridos",
  "stats.goals_over_time": "Gols ao longo do tempo",
  "stats.details": "Detalhes",
  "stats.player_details": "Detalhes do jogador",
  "stats.team_details": "Detalhes do time",
  "stats.no_data": "Sem dados para este período.",
  ...
  "match.filter_winner": "Vencedor",
  "match.search_placeholder": "Buscar jogador ou nota…",
  "match.sort": "Ordenar",
  "match.sort_newest": "Mais recentes",
  "match.sort_oldest": "Mais antigas",
  "match.sort_goals": "Mais gols",
  "match.details": "Detalhes da partida",
  "match.total_goals": "Total de gols",
  "match.goal_diff": "Saldo de gols",
  "match.edit_title": "Editar partida",
  "match.updated": "Partida atualizada",
  "match.swipe_hint": "Deslize ← para excluir · → para editar",
  "ranking.champion": "Campeão atual",
  "ranking.best_winrate": "Melhor aproveitamento",
  "ranking.top_scorer": "Artilheiro",
  "ranking.most_active": "Mais ativo",
  "ranking.played": "Jogos",
  "ranking.wins": "Vitórias",
  "ranking.draws": "Empates",
  "ranking.losses": "Derrotas",
  "ranking.goals_for": "GP",
  "ranking.goals_against": "GC",
  "ranking.goal_diff": "SG",
  "ranking.win_rate": "Vit. %",
...
const es: Dict = {
  ...
  "stats.kpi.total_matches": "Partidos totales",
  "stats.kpi.total_goals": "Goles totales",
  "stats.kpi.avg_goals": "Goles / partido",
  "stats.kpi.most_active": "Más activo",
  "stats.kpi.top_scorer": "Goleador",
  "stats.kpi.best_defense": "Mejor defensa",
  "stats.kpi.best_win_rate": "Mejor % victorias",
  "stats.kpi.most_used_team": "Equipo más usado",
  "stats.filter.all": "Siempre",
  "stats.filter.week": "Esta semana",
  "stats.filter.month": "Este mes",
  "stats.filter.custom": "Personalizado",
  "stats.filter.from": "Desde",
  "stats.filter.to": "Hasta",
  "stats.matches_played": "Partidos jugados",
  "stats.goals_scored": "Goles marcados",
  "stats.goals_conceded": "Goles recibidos",
  "stats.goals_over_time": "Goles en el tiempo",
  "stats.details": "Detalles",
  "stats.player_details": "Detalles del jugador",
  "stats.team_details": "Detalles del equipo",
  "stats.no_data": "Sin datos en este período.",
  "settings.title": "Ajustes",
  ...
  "ranking.champion": "Campeón actual",
  "ranking.best_winrate": "Mejor % de victorias",
  "ranking.top_scorer": "Goleador",
  "ranking.most_active": "Más activo",
  "ranking.played": "Jugados",
  "ranking.wins": "Victorias",
  "ranking.draws": "Empates",
  "ranking.losses": "Derrotas",
  "ranking.goals_for": "GF",
  "ranking.goals_against": "GC",
  "ranking.goal_diff": "DG",
  "ranking.win_rate": "Vict. %",
